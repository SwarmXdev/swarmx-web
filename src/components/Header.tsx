    ...
    <header className="border-b border-gray-800 bg-swarm-dark/80 backdrop-blur-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <a href="/" className="text-xl font-bold text-white">SwarmX</a>
        </div>
        ...
        <WalletMultiButton className="!bg-swarm-primary hover:!bg-swarm-primary/80 !rounded-lg !text-sm !font-medium !transition" />
      </div>
    </header>
  );
}
